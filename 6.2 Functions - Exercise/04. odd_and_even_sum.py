...
# Ще получите един номер. Трябва да напишете функция,
# която връща сумата от всички четни и всички нечетни цифри в дадено число.
# Резултатът трябва да бъде върнат като единичен низ във формат:
# "Нечетна сума = {сума_на_нечетни_цифри}, Четна сума = {сума_на_четни_цифри}"
# Отпечатайте резултата от функцията на конзолата.
